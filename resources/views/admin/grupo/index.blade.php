			...
			@foreach($grupos as $grupo)
				<tr>
					...
					<td>
						...
						@endcan
						@can('is_admin', $acceso_auth)
							<a href="{{ route('admin.cursogrupo.edit', $grupo->id) }}" class="btn btn-success" data-toggle="tooltip" title="Relacionar grupo" name = "{{'Relation'.$grupo->id}}"><span class="glyphicon glyphicon-transfer" aria-hidden='true'></span></a>

							<a href="{{ route('admin.cursogrupo.index', $grupo->id) }}" class="btn btn-success" data-toggle="tooltip" title="Prioridad docentes" name = "{{'Relation'.$grupo->id}}"><span class="glyphicon glyphicon-sort" aria-hidden='true'></span></a>
